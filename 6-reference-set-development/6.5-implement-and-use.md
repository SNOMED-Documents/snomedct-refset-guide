...
<figure><img src="../.gitbook/assets/35985731.png" alt=""><figcaption><p>Prior to implementation a reference set may be transformed into one or more formats, which are optimized for the particular use of the reference set</p></figcaption></figure>
